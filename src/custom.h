...
/**
 * integrate using original VF
 */
#define INTCONFIG_ORIGINAL 1
/**
 * integrate using reduced VF when possible
 */
#define INTCONFIG_REDUCED 0
/**
 * default value for HMA (=MAXIMUM STEP SIZE)
 */
#define DEFAULT_HMA 1.E-1
/**
 * minimum value for HMA = 10^(-16)
 */
#define MIN_HMA 1.E-32
/**
 * maximum value for HMA = 10^1
 */
#define MAX_HMA 10.0
/**
 * default value for HMI (=MINIMUM STEP SIZE)
 */
#define DEFAULT_HMI 1.E-6
/**
 * minimum value for HMI
 */
#define MIN_HMI 1.E-32
/**
 * maximum value for HMI
 */
#define MAX_HMI 10.0

/**
 * default step size. must be in between HMI and HMA
 */
#define DEFAULT_STEPSIZE 0.01

/**
 * default projection (Poincare sphere only)
 */
#define DEFAULT_PROJECTION -1.0
/**
 * projection can be VERY negative
 */
#define MIN_PROJECTION -1.E16
/**
 * projection must be strictly negative
 */
#define MAX_PROJECTION -1.E-32
 ...
 * minimum tolerance
 */
#define MIN_TOLERANCE 1.E-32
/**
 * maximum tolerance
 */
#define MAX_TOLERANCE 1.0

/**
 * number of points during integration
 */
#define DEFAULT_INTPOINTS 200
/**
 * minimum number of points during integration
 */
#define MIN_INTPOINTS 1
/**
 * maximum number of points during integration
 */
#define MAX_INTPOINTS 32767

/**
 * choose between LINESTYLE_DASHES and LINESTYLE_POINTS
 */
#define DEFAULT_LINESTYLE LINESTYLE_DASHES
/**
 * after each 100 points of integration: update
 * "current step size" field in this window.
 */
#define UPDATEFREQ_STEPSIZE 100

// limit cycles window:

/**
 * number of orbits to integrate before progress window is updated
 */
#define DEFAULT_LCORBITS 1
/**
 * when dividing transverse section length by
 */
#define MIN_LCORBITS 1
/**
 * grid: number of orbits must lie between these values
 */
#define MAX_LCORBITS 32767

/**
 * number of points to integrate EACH orbit
 */
#define DEFAULT_LCPOINTS 2000
/**
 * minimum number of points to integrate EACH orbit
 */
#define MIN_LCPOINTS 1
/**
 * maximum number of points to integrate EACH orbit
 */
#define MAX_LCPOINTS 32767

/**
 * division interval for the transverse section
 */
#define DEFAULT_LCGRID 0.01
/**
 * minimum division interval for the transverse section
 */
#define MIN_LCGRID 1.E-16
/**
 * maximum division interval for the transverse section
 */
...
/**
 * Determine when the point (in the R2-chart)
 * of the orbit goes to infinity. If z coord on the poincare sphere is
 * less than ZCOORD then point goes to infinity
 */
