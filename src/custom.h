...
#define MIN_LCGRID                                                             \
    1.E-16 ///< minimum division interval for the transverse section
#define MAX_LCGRID                                                             \
    1E16 ///< maximum division interval for the transverse section
...
#define ZCOORD                                                                 \
    (sqrt(2) / 2) /**< Determine when the point (in the R2-chart)              \
