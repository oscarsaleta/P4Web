...
void integrateOrbit( WWinSphere *, int );

orbits_points * integrate_orbit( WWinSphere *, double *, double,int, int, int, orbits_points ** );

void drawOrbit( WWinSphere * spherewnd, double * pcoord, struct orbits_points * points, int color );

bool startOrbit( WWinSphere * sphere, double x, double y, bool R );

void drawOrbits( WWinSphere * spherewnd );

void deleteLastOrbit( WWinSphere * spherewnd );
