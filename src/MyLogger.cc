...
void MyLogger::debug(std::string message) { log("debug", message); }

void MyLogger::info(std::string message) { log("info", message); }

void MyLogger::warning(std::string message) { log("warning", message); }

void MyLogger::secure(std::string message) { log("secure", message); }

void MyLogger::error(std::string message) { log("error", message); }

void MyLogger::fatal(std::string message) { log("fatal", message); }