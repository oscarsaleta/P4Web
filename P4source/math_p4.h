...
void (*plot_l)( QWinSphere *, double *, double *, int );
void (*plot_p)( QWinSphere *, double *, int );
...
orbits_points  *integrate_blow_up(  QWinSphere *, //double, double,
        double *, blow_up_points *, double, int, int, orbits_points **, int );

int change_type( int );
int FindSepColor( term2 *, int, double * );
